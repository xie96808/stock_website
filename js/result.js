...
function calcGrade(finalReturnPercent, bsScore) {
    ...
    if (score >= 2)   return { letter: 'B', title: '稳健操盘手', verdict: '整体操作稳健，略有遗憾但瑕不掩瑝。继续磨练！', cls: 'grade-B' };
    if (score >= -5)  return { letter: 'C', title: '非菜培育中', verdict: '不亏不赚，或许下次运气更好一些？', cls: 'grade-C' };
    return              { letter: 'D', title: '慈善非菜', verdict: '亏损严重……别担心，这只是模拟，现实里要三思啊。', cls: 'grade-D' };
}
