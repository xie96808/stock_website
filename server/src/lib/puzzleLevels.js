...
export const CHAPTER1_LEVEL_DEFS = [
  ...
  },
  {
    ...
    title: "到手的利润",
    theme: "初始持仓处于浮盈",
    teachingBrief: "开局已有浮盈。利润会吐回去——学会把账面上的收益落袋为安。",
    openStateHint: "开局已满仓浮盈，可卖可持",
    gameDays: 8,
    maxOrders: 1,
    stockCode: PUZZLE_PUBLIC_STOCK_CODE,
    stockName: "残局·止盈",
  ...
  },
  {
    ...
    title: "两笔机会",
    theme: "空仓、最多两笔实际成交订单",
    teachingBrief: "空仓起步，本关最多两笔成交。想清楚何时买、何时卖，第三笔会被拒绝。",
  ...
  },
  {
    ...
    title: "明天才好卖",
    theme: "刚买入的锁定持仓",
    teachingBrief: "刚在开盘价成交的仓位受 T+1 限制：第一天不能卖，得等到可卖日再决策。",
    openStateHint: "开局已满仓且 T+1 锁定，首日不可卖",
    gameDays: 8,
    maxOrders: 1,
    stockCode: PUZZLE_PUBLIC_STOCK_CODE,
    stockName: "残局·T+1",
  ...
  },
  {
    ...
    title: "震荡磨人",
    theme: "已有持仓、窄幅行情",
    teachingBrief: "窄幅震荡后可能突然破位。控制交易次数，避免在磨人行情里来回挨打。",
    openStateHint: "开局已满仓，订单上限 2 笔",
    gameDays: 8,
    maxOrders: 2,
    stockCode: PUZZLE_PUBLIC_STOCK_CODE,
    stockName: "残局·震荡",
  ...
  },
  {
    ...
    title: "最后几个交易日",
    theme: "带持仓进入短窗口",
    teachingBrief: "短窗口末日只估值、不能再下单。中途卖出与拿到最后收盘价，结果可能差一截。",
    openStateHint: "开局已满仓，末日仅估值",
    gameDays: 7,
    maxOrders: 1,
    stockCode: PUZZLE_PUBLIC_STOCK_CODE,
    stockName: "残局·到期",
