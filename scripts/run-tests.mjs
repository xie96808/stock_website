...
const runs = [
  ["node", ["--test", "tests/engine/engine.test.js", "tests/engine/equity-curve.test.js", "tests/engine/puzzle-engine.test.js", "tests/cloud-draft.test.js", "tests/screen-router.test.js", "tests/analysis-pure.test.js", "tests/kline-option.test.js", "tests/game-session.test.js", "tests/pack-url.test.js", "tests/time.test.js"]],
